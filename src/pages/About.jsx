        ...
        <div className="grid-2" style={{ alignItems: 'center', marginBottom: '80px' }}>
          ...
          <div style={{ backgroundColor: 'var(--primary-light)', padding: '40px', borderRadius: 'var(--border-radius-lg)', border: '1px solid rgba(13, 74, 59, 0.08)' }}>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '24px' }}>
              <li>
                <h4 style={{ fontSize: '1.1rem', marginBottom: '6px', color: 'var(--primary-color)' }}>❤️ Compassion First</h4>
              ...
              <li>
                <h4 style={{ fontSize: '1.1rem', marginBottom: '6px', color: 'var(--primary-color)' }}>⚖️ Affordability & Transparency</h4>
